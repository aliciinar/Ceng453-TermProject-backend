...
import com.Spaces.NormalSpaces.GoJail;
import com.Spaces.NormalSpaces.IncomeTax;
import com.Spaces.NormalSpaces.JailVisit;
import com.Spaces.NormalSpaces.StartingPoint;
import com.Spaces.TitleDeeds.FerryPort;
import com.Spaces.TitleDeeds.Properties;
import com.Spaces.TitleDeeds.RailRoad;
    ...
    private  void  AddIncomeTax(List<Integer> usedIndexes,HashMap<Integer,ISpace> spaces){
        ...
        for(int i = 0; i < 20; i++){
            if(!usedIndexes.contains(i)){
                ISpace incomeTax = new IncomeTax();
